...
const base = 'https://doecjt.cool'
const tweetUrl = computed(() => `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Reading @doecjt\'s ${base}${route.path}\n\nI think...`)}`)
const elkUrl = computed(() => `https://elk.zone/intent/post?text=${encodeURIComponent(`Reading @doecjt@m.webtoo.ls\'s ${base}${route.path}\n\nI think...`)}`)
